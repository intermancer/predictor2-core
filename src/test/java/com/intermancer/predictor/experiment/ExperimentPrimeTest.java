...
public class ExperimentPrimeTest extends SystemTest {
	...
	public void testRunExperimentCycle() throws Exception {
		...
		assertTrue(experimentRunner.getOrganismStore().getCount() == InMemoryQuickAndDirtyOrganismStore.DEFAULT_MAX_CAPACITY);
			...
			System.out.println(
					StringEscapeUtils.escapeJava(
							mapper.writeValueAsString(
									experimentRunner.getOrganismStore().findByIndex(i).getOrganism())));
		}
	...
	public void testHydration2() throws Exception {
		...
		OrganismStoreRecord hydratedOrganism = 
				mapper.readValue(jsonOrganism, OrganismStoreRecord.class);
		assertNotNull(hydratedOrganism);
